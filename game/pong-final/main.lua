...
function love.update(dt)
 ...
 if gameMode == 0 then -- AI player
    ...
    --
    if player1.y + (PADDLE_HEIGHT / 1) < ball.y + (BALL_HEIGHT / 2) and ball.x < VIRTUAL_WIDTH - VIRTUAL_WIDTH / 3 then 
        player1.dy = PADDLE_SPEED
    elseif player1.y + (PADDLE_HEIGHT / 1) > ball.y + (BALL_HEIGHT / 2) and ball.x < VIRTUAL_WIDTH - VIRTUAL_WIDTH / 3 then
        player1.dy = -PADDLE_SPEED
    else
        player1.dy = 0
    end   
...
function love.keypressed(key)
    ...
    elseif key == 'enter' or key == 'return' then
        ...
        elseif gameState == 'done' then
            ...
            -- decide serving player as the opposite of who win
...
function love.draw()
    ...
    if gameState == 'start' then
       ...
       love.graphics.printf(tostring(gameMode) .. ' player Mode, Press 0, 1 or 2 to change.', 0, 40, VIRTUAL_WIDTH, 'center')
...
function displayFPS()
    ...
    love.graphics.setFont(smallFont)
    love.graphics.setColor(0, 255/255, 1, 255/255)
